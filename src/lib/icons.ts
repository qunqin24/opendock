/**
 * Inline icon set for category tiles, hand-copied (path data only, no
 * dependency) from lucide-react v1.31 so the homepage doesn't have to ship
 * a React island just to draw fourteen glyphs. Names match `Category.icon`
 * in the plugin dataset. Render with <CategoryIcon />.
 */
