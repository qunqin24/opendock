...
[![npm version](https://img.shields.io/npm/v/@nemowang2003/opencode-goal-plugin.svg)](https://www.npmjs.com/package/@nemowang2003/opencode-goal-plugin)
[![GitHub repository](https://img.shields.io/badge/GitHub-nemowang2003%2Fopencode--goal--plugin-blue?logo=github)](https://github.com/nemowang2003/opencode-goal-plugin)
...
- npm package: [`@nemowang2003/opencode-goal-plugin`](https://www.npmjs.com/package/@nemowang2003/opencode-goal-plugin)
- GitHub repository: [`nemowang2003/opencode-goal-plugin`](https://github.com/nemowang2003/opencode-goal-plugin)
- OpenCode plugin command: `opencode plugin @nemowang2003/opencode-goal-plugin`
...
```bash
opencode plugin @nemowang2003/opencode-goal-plugin
```

Install globally:

```bash
opencode plugin -g @nemowang2003/opencode-goal-plugin
```
...
```json
{
  "plugin": ["@nemowang2003/opencode-goal-plugin"]
}
```
...
```json
{
  "plugin": [
    [
      "@nemowang2003/opencode-goal-plugin",
      {
        "auto_continue": true,
...
3. Use repository `nemowang2003/opencode-goal-plugin`.
